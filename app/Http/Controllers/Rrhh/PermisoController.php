...
class PermisoController extends Controller
{
    ...
    {
        return view('administrativo.asistencia.permiso.index',
            [
    ...
    {
        $permiso = permiso::select('id','numca','empleado','dia','fecha','regentrada','regsalida', \DB::raw('date_add(timediff(regsalida, regentrada), INTERVAL -1 HOUR) as trabajado'), 'ausente');
    ...
    {
        return view('administrativo.biometrico.permiso.create',
            [
                'breadcumb' => $this->breadcumb,
                'sidebar'=> $this->sidebar,
