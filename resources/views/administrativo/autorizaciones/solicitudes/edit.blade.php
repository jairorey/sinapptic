...
<section class="panel panel-default">
    ...
    <div class="panel-body">
        {!! Form::model($solicitud, array('id' => 'frmSolicitud', 'url' => array('autorizaciones/solicitudes/update',$solicitud), 'method' => 'PUT', 'role' =>'form')) !!}
            ...
            <a class="btn btn-default" data-toggle="modal" data-target="#hojaderuta" title="Detalle de Rutas"><span class="fa fa-road"></span> Hoja de Ruta</a>
            <a href="{{ url('previewpdfsol', $solicitud->id) }}" target="_blank" title='Vista Previa de Solicitud' class='btn btn-default'><span class='fa fa-share-square-o'></span> Ver en PDF</a>
