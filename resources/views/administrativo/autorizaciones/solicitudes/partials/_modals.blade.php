...
<div id="divArchivar" class="modal fade" aria-labelledby="divArchivar">
    <div class="modal-dialog">
        <div class="modal-content">
            {!! Form::open(array('id' => 'frmArchivar', 'url' => 'autorizaciones/solicitudes/enviar', 'method' => 'POST', 'role' =>'form', 'enctype' => 'multipart/form-data')) !!}
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title">Confirmación</h4>
            </div>
...
$('#divConfirmEjecutivo').on('show.bs.modal', function(e){
    ...
    $('#divConfirmEjecutivo #user').text($(e.relatedTarget).data('emisor-nombre'));
