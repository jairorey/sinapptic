...
<section class="panel panel-default">
    <header class="panel-heading font-bold">
        <span class="fa fa-list-alt"></span><span> Creación de Aplicativos</span>
    </header>
    <div class="panel-body">
        {!! Form::open(array('url' => 'core/aplicativos/store', 'method' => 'POST', 'role' =>'form')) !!}
            @include('core.aplicativos.partials._fields')
            <footer class="panel-footer bg-light lter">
            
            <div class="btn-actions">
            	<button type="submit" class="btn btn-success"><span class="fa fa-save"></span> Guardar</button>
            	<a class="btn btn-default" href="{{ url('core/aplicativos') }}">Cerrar</a>	
            </div>
            </footer>
        {!! Form::close() !!}
    </div>
