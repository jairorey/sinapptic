<div class="form-group pull-in clearfix">
    <div class="col-sm-2 m-t-lg text-center">
        {!! Form::image('uploads/avatars/default.jpg', 'alt',array('class' => 'img-circle thumb-lg m-l')) !!}
    </div>
    <div class="col-sm-5">
...
<div class="form-group pull-in clearfix">
    <!-- <div class="col-sm-4">
    <br />
        <input type="file" id="avatar" name = "avatar" class="filestyle" data-icon="false" data-classButton="btn btn-default" data-classInput="form-control inline input-s">
    </div> -->
